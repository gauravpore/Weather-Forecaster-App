...
st.write("## 👨🏻‍💻 Created by Gaurav Pore")
st.markdown("[GitHub](https://github.com/gauravpore) | [Twitter](https://twitter.com/gaurav_pore) | [Instagram](https://www.instagram.com/gaurav._.app/)")
st.write("### Enter City name and select the Temperature Unit and Graph Type :")
...
st.write('## Note: Enter PIN CODE only if City is not found ')
